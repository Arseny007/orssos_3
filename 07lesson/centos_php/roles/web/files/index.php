...
<head>
<meta charset="utf-8">
<title> Postrgsql SELECT</title>

</head>
<body>
    <?php
    $db = pg_connect("host=192.168.56.5 port=5432 dbname=demo user=postgres password=postgres");
    $result = pg_query($db, "select * from airports limit 6");
echo "<table border=2>";
